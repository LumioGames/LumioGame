...
| 文档 | 状态 | 一句话 |
|---|---|---|
| [bomber/design.md](bomber/design.md) | 设计中 | 体素炸弹人完整设计稿:100 人 .io 帽子乱斗与滚动房间、三心血量与连锁结算、最后一命决赛圈与死亡掉强化、人数-地图联动与双密度指标、场景材质、分区补给箱与中央定时补给、3 槽装备(Stage 5)、可读性功能、首轮默认值、Gate 0 + Stage 0–6 切片与遥测门槛——首发产品(阶梯 ①) |
