...
| [`features/gameplay/entity-chat-harness.md`](features/gameplay/entity-chat-harness.md) | 101-entity C# MVP acceptance harness——查 Bot01–Bot100 启动、Account Server 登录与两轮对比 |
